...
2. Create three vectors and then combine them into a list.

3. If `x` is a list, what is the class of `x[1]`? How about `x[[1]]`?

### Data Frames [NOTE: Must introduce attributes / names and reassignment for this challenge to work.]
